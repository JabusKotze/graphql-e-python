...
class Lead(Base):
    ...
    uuid = sa.Column(sa.String(32), default=lambda: uuid.uuid4().hex, nullable=False)
...
sa.Index('lead_name_index', Lead.name)
sa.Index('lead_cpf_index', Lead.cpf)
sa.Index('lead_email_index', Lead.email)
sa.Index('lead_loan_reason_index', Lead.loan_reason)
